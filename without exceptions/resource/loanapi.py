...
def loan_api(app):
    ...
    def update_loan(customer_username):
        ...
        if y>0:
            record = json.loads(request.data)
            customer = Loan.objects(username=customer_id)
            ...
            return jsonify({"output":"you does not have any loans to update"})
    ...
    def delete_loan(customer_username):
        ...
        if y>0:
            ...
            return jsonify({"output":"you does not have any loans to delete"})
